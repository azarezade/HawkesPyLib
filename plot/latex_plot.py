...
def main():
    ...
    obj_opl = sio.loadmat('../result/opl_max_obj_events_vs_budget.mat')['obj']
    ...
    obj, budget = load(path)
    obj_opl = sio.loadmat('../result/opl_max_obj_events_vs_budget.mat')['obj_emp']
    obj = np.vstack((obj, obj_opl))
    ...
    obj, budget = load(path)
    obj_opl = sio.loadmat('../result/opl_shaping_obj_events_vs_budget.mat')['obj']
    ...
    obj, budget = load(path)
    obj_opl = sio.loadmat('../result/opl_shaping_obj_events_vs_budget.mat')['obj_emp']
    obj = np.vstack((obj, obj_opl))
